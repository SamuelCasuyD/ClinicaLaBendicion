 ...
 */
public class AnalisisSolicitudesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else if (menu.equalsIgnoreCase("analisisSolicitudes")){   
                       
            request.getRequestDispatcher("AnalisisSolicitudes.jsp").forward(request, response);
